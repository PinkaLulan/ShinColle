...
public class ContainerSmallShipyard extends Container {
	...
	public ContainerSmallShipyard(InventoryPlayer invPlayer, TileEntitySmallShipyard teSmallShipyard) {
		...
		this.addSlotToContainer(new SlotSmallShipyard(invPlayer.player, teSmallShipyard, 1, 53, 29));  //abyssium
		this.addSlotToContainer(new SlotSmallShipyard(invPlayer.player, teSmallShipyard, 2, 73, 29));  //ammo
		this.addSlotToContainer(new SlotSmallShipyard(invPlayer.player, teSmallShipyard, 3, 93, 29));  //poly
		this.addSlotToContainer(new SlotSmallShipyard(invPlayer.player, teSmallShipyard, 4, 8, 53));   //fuel
		this.addSlotToContainer(new SlotSmallShipyard(invPlayer.player, teSmallShipyard, 5, 145, 29)); //output
