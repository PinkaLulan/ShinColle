...
//			this.fontRendererObj.drawStringWithShadow(strFuel, 25-strLen, 47, 16777215);
	...
	protected void mouseClicked(int posX, int posY, int mouseKey) {
        ...
        case 0:	//build ship
        	...
        	CommonProxy.channel.sendToServer(new C2SGUIPackets(this.tile, ID.B.Shipyard_Type, buildType, 0));
        	break;
        case 1:	//build equip
        	if(buildType == 2) {
        ...
        case 2:	//inventory mode
        	...
        	CommonProxy.channel.sendToServer(new C2SGUIPackets(this.tile, ID.B.Shipyard_InvMode, invMode, 0));
        	break;
        ...
        case 6: //polymetal
        	...
        	CommonProxy.channel.sendToServer(new C2SGUIPackets(this.tile, ID.B.Shipyard_SelectMat, selectMat, 0));
        	break;
        ...
        //other page button
        buttonClicked = GuiHelper.getButton(ID.G.LARGESHIPYARD, selectMat+1, xClick, yClick);
        switch(buttonClicked) {
        ...
        case 7:	//build mat -1
        	...
        	CommonProxy.channel.sendToServer(new C2SGUIPackets(this.tile, ID.B.Shipyard_INCDEC, selectMat, buttonClicked));
        	break;	
