...
public class CalcHelper
{
    ...
    /** get distance vector with host type checking */
    public static Dist4d getDistanceFromA2B(Object host, Entity target)
    {
        ...
        {
            return getDistanceFromA2B(new Vec3d(((TileEntity) host).getPos().getX() + 0.5D,
                                                ((TileEntity) host).getPos().getY() + 0.5D,
                                                ((TileEntity) host).getPos().getZ() + 0.5D),
