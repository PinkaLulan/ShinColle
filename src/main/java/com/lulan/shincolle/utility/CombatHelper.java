...
public class CombatHelper
{
    ...
    public static float modDamageByAtkType(AtkType type, Entity target, float dmg)
    {
        ...
        case AP91_FIST:        //nagato heavy attack
            modEffect = 4F;
        break;
        case YAMATO_CANNON:    //yamato heavy attack
            modEffect = 1.5F;
        break;
        default:
        break;
     ...
     * @return new attack damage
     */
    public static float modDamageByAttrs(AttrStateHandler state, Entity target, float dmg)
    {
        float newDmg = dmg;
        
        //check target type is fly or undersea
        MoveType type = EntityHelper.getEntityMoveType(target);
