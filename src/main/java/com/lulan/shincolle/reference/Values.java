...
//		put(ID.ShipType.,	new int[] {99, 87});  //empty for now
	...
	{{
		...
		//drum
		put((int)ID.EquipType.DRUM_LO + (int)ID.EquipSubID.DRUM_N * 100,        		new float[]{2F, 0,   0F,  0F,  0F,  0F,  0F, 0F,   -0.25F, 0F,   0F,    0F,    0F,    0F,    0F,  0F,  ID.EquipType.DRUM_LO,  	  2000F,  0F,  120,  1,  3});
		//compass
