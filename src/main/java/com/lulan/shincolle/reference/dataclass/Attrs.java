...
public class Attrs
{
    ...
    //sync flags except AttrsBuffed
    public boolean syncBonus;
    public boolean syncType;
    public boolean syncRaw;
    public boolean syncEquip;
    public boolean syncPotion;
    ...
    /** check buffed attrs limit, must apply BOTH SIDE */
    ...
    public static void checkAttrsLimit(float[] data)
    {
        ...
        if (data[ID.Attrs.SPD] < 0.1F) data[ID.Attrs.SPD] = 0.1F;
    }
