...
public class ServerProxy extends CommonProxy
{
	...
	public static boolean setPlayerTargetClass(int pid, String str)
	{
		...
		if (str != null && str.length() > 1 && pid > 0)
		{
			...
			if (tarList != null)
			{
				...
				setPlayerTargetClass(pid, tarList);
				serverData.markDirty();
			}
	...
	public static HashMap<Integer, int[]> getAllPlayerWorldData()
	{
		return mapPlayerID;
	}
...
//						LogHelper.info("INFO : server proxy tick: tar list "+s);
//					}
//				}
...
//				LogHelper.info("INFO : server proxy tick: ");
//				if(serverData != null && serverData.nbtData != null) {
//					NBTTagList list2 = serverData.nbtData.getTagList(ShinWorldData.TAG_TEAMDATA, Constants.NBT.TAG_COMPOUND);
//					LogHelper.info("INFO : server proxy tick: "+serverData.isDirty()+" "+mapTeamID.size()+" "+list2);
//				}
			}
