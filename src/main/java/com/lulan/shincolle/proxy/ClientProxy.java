...
import com.lulan.shincolle.client.render.RenderCarrierAkagi;
import com.lulan.shincolle.client.render.RenderCarrierAkagiBoss;
...
import com.lulan.shincolle.client.render.RenderDestroyerIkazuchi;
...
public class ClientProxy extends CommonProxy {
	...
	public void registerRender() {
		...
		RenderingRegistry.registerEntityRenderingHandler(EntityCarrierAkagi.class, new RenderCarrierAkagi(new ModelCarrierAkagi(0), 0.7F));
		RenderingRegistry.registerEntityRenderingHandler(EntityCarrierAkagiBoss.class, new RenderCarrierAkagiBoss(new ModelCarrierAkagi(1), 1.2F));
...
//		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerHibikiMob.class, new RenderDestroyerHibiki(new ModelDestroyerHibiki(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerIkazuchi.class, new RenderDestroyerIkazuchi(new ModelDestroyerIkazuchi(), 0.5F));
		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerIkazuchiMob.class, new RenderDestroyerIkazuchi(new ModelDestroyerIkazuchi(), 0.5F));
//		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerInazuma.class, new RenderDestroyerInazuma(new ModelDestroyerInazuma(), 0.5F));
//		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerInazumaMob.class, new RenderDestroyerInazuma(new ModelDestroyerInazuma(), 0.5F));
