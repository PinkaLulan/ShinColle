...
//		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerHibiki.class, new BasicShipRenderer(new ModelDestroyerHibiki(), 0.5F, ID.Ship.));
//		RenderingRegistry.registerEntityRenderingHandler(EntityDestroyerHibikiMob.class, new BasicShipRenderer(new ModelDestroyerHibiki(), 0.5F, ID.Ship.));
