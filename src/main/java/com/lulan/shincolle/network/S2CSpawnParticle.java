		...
		case 0:	//spawn particle with entity
			{
				...
				ParticleHelper.spawnAttackParticle(entity, particleType, setAtkTime);	
			}
			break;
		case 1: //spawn particle with entity and position
			{
				...
				entity = EntityHelper.getEntityByID(entityID, 0, true);
				ParticleHelper.spawnAttackParticleCustomVector(entity, posX, posY, posZ, lookX, lookY, lookZ, particleType, setAtkTime);
			}
			break;
		...
		case 3: //spawn particle with position
			{
				...
				ParticleHelper.spawnAttackParticleAtEntity(entity, entity2, posX, posY, posZ, particleType, setAtkTime);
			}
			break;
