...
public class BlockSmallShipyard extends BasicBlockContainer {
	...
	public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
		...
		smokeR1 = ParticleHelper.rotateParticleByFace(smoke1[0], smoke1[1], smoke1[2], meta, 1);
		smokeR2 = ParticleHelper.rotateParticleByFace(smoke2[0], smoke2[1], smoke2[2], meta, 1);
		smokeR3 = ParticleHelper.rotateParticleByFace(smoke3[0], smoke3[1], smoke3[2], meta, 1);
