...
public class ModEntity {
	...
	public static void init() {
		...
		createEntity(EntityDestroyerI.class, Reference.MOD_ID_LOW+":EntityDestroyerI", 0xEC4545, 0x001EFF, regEntityId++);
		
		//register projectile entity
		EntityRegistry.registerModEntity(EntityAbyssMissile.class, Reference.MOD_ID_LOW+":EntityAbyssMissile", regEntityId++, ShinColle.instance, 128, 1, true);
	}
	
	//登錄生物方法
	//參數: 該生物class, 生物名稱, 怪物蛋背景色, 怪物蛋斑點色
	public static void createEntity(Class entityClass, String entityName, int backColor, int spotColor, int entityID){
