...
//		createEntity(EntityDestroyerAkatsuki.class, "EntityDestroyerIkazuchi", modEntityID++);
//		createEntity(EntityDestroyerAkatsukiMob.class, "EntityDestroyerIkazuchi", modEntityID++);
//		createEntity(EntityDestroyerHibiki.class, "EntityDestroyerIkazuchi", modEntityID++);
//		createEntity(EntityDestroyerHibikiMob.class, "EntityDestroyerIkazuchi", modEntityID++);
...
//		createEntity(EntityDestroyerInazuma.class, "EntityDestroyerIkazuchi", modEntityID++);
//		createEntity(EntityDestroyerInazumaMob.class, "EntityDestroyerIkazuchi", modEntityID++);
